...
FIGURES_DESC = FIGURES_DIR / 'descriptive'
FIGURES_REG = FIGURES_DIR / 'regression'
FIGURES_MAPS = FIGURES_DIR / 'maps'

# Create directories if they don't exist
for path in [DATA_RAW, DATA_INTERIM, DATA_PROCESSED, 
             RESULTS_TABLES, RESULTS_REGRESSION, RESULTS_ROBUSTNESS,
             FIGURES_DESC, FIGURES_REG, FIGURES_MAPS, LOGS_DIR]:
