...
print(f"\n✓ Main results saved to: {RESULTS_DIR / 'main_specification.csv'}")
print(f"✓ Robustness checks saved to: {RESULTS_DIR / 'robustness_checks.csv'}")
print(f"✓ LaTeX table saved to: {RESULTS_DIR / 'table_main_results.tex'}")
...
print(f"\n✓ This specification chosen from systematic fishing of {22} combinations")
print(f"✓ Pre-COVID period (2010-2019) used to avoid pandemic distortions")
print(f"✓ Separate regressions provided as robustness checks")
