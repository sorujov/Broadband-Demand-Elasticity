...
\textbf{Alternative control specifications:} Beyond the full controls baseline, we estimate six additional specifications ranging from minimal (GDP only) to intermediate groupings of socioeconomic, institutional, infrastructure, demographic, and macroeconomic controls. Seven specifications in total are reported in Table~\ref{tab:baseline}. This addresses concerns about overcontrol or omitted variables.
